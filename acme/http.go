...
func (c *ACME) retryTimer() *retryTimer {
	f := c.RetryBackoff
	if f == nil {
		f = defaultBackoff
	}
...
func (c *ACME) get(ctx context.Context, url string, ok resOkay) (*http.Response, error) {
	retry := c.retryTimer()
	for {
...
func (c *ACME) doNoRetry(ctx context.Context, req *http.Request) (*http.Response, error) {
...
func (c *ACME) httpClient() *http.Client {
	if c.HTTPClient != nil {
		return c.HTTPClient
	}
